...
const App: React.FC = () => {
  return (
    <div className="min-h-screen bg-black flex justify-center items-start p-4 md:p-10">
      <div className="w-full max-w-md space-y-8 animate-fade-in-up">
        ...
        <footer className="text-center py-8">
          <p className="text-[10px] text-zinc-600 uppercase tracking-[0.3em] mb-1">
            MTM Advocacia & Consultoria Jurídica
          </p>
          <p className="text-[9px] text-zinc-700 italic">
            Excelência e compromisso com o seu direito.
          </p>
        </footer>
      </div>
